...
{
public:
    explicit stdStableSort() : BaseTestPattern("std::stable_sort")
    {
    }
...
private:
    virtual void sort_impl()
    {
        ...
        mysort::stdStableSort(m_testData.begin(), m_testData.end(), comp);
        count = comp.getCount();
        comp.resetCount();
    }
};

class stdSort : public BaseTestPattern
{
public:
    explicit stdSort() : BaseTestPattern("std::sort")
    {
    }
...
private:
    ...
    {
        mysort::CompareCounter<ELEMENT_TYPE> comp;
        mysort::stdSort(m_testData.begin(), m_testData.end(), comp);
        count = comp.getCount();
        comp.resetCount();
    }
};
