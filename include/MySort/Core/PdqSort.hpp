...
template <class _It, class _Pr = std::less<>>
void pdqSort(_It, _It, const _Pr& = {})
{
...
template <class _It, class _Pr = std::less<>>
void pdqSort_branchless(_It, _It, const _Pr& = {})
{
    YWARNING("Pattern-Defeating Quicksort branchless requires random access iterator. Skip sorting.");
}
template <class _It, class _Pr = std::less<>>
    requires std::random_access_iterator<_It>
